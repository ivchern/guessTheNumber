...
///СДЕЛАЛ СКРЫТЫЙ ВВОД ЧТОБЫ И АВТОМАТИЧЕСКИ СУЖАЕМЫЙ ДИАПОЗОН///
using System;
...
namespace guessTheNumber
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Введите цифру режима игры и нажмите Enter:\n" +
                               "1.Человек и человек\n" +
                               "2.Машина и человек\n" +
                               "3.Человек и машина\n" +
                               "4.Машина и Машина"); //добавил еще один режим, потому что он крутой 
            ...
            if (choiceUser == 1)
            {
                ...
                int userNumber = player.InputUserNumber();
                guess.PlayerGuess(userNumber, choiceUser);
            ...
            if(choiceUser == 2)
            {
                ...
                guess.PlayerGuess(machine.machineGiveNumber, choiceUser);
